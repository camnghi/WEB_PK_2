        ...
        <div class="row">
            <div class="col-sm-3 col-md-3 col-lg-3">
                ...
                <a href="/indexAD/form"
                    ...
                    <svg class="bi me-2" width="40" height="40"><use xlink:href="#people-circle"/></svg>
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="mb-1">
                        <button
                            ...
                            data-bs-target="#sanpham-collapse" aria-expanded="true">
                    ...
                    <li class="mb-1">
                        <button
                            class="btn btn-toggle align-items-center rounded collapsed"
                            data-bs-toggle="collapse"
                            data-bs-target="#thongke-collapse" aria-expanded="true">
                            <svg class="bi me-2" width="16" height="16"><use
                                xlink:href="#people-circle" /></svg>
                            Quản lý thống kê
                        </button>
                        <div class="collapse" id="thongke-collapse">
                            <ul
                                class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li><a href="${pageContext.request.contextPath}/quanLyThongKe/form"
                                        class="link-dark rounded">
                                    Top sản phẩm bán chạy</a></li>
                                <li><a href="${pageContext.request.contextPath}/quanLyThongKe/form" class="link-dark rounded">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                        ...
                                        <input type="file" class="choose-file" name
                                            id>
                                    </div>
                                        ...
                                        <select class="form-select form-select-sm" name="" id="">
                                            ...
                                            <div
                                                ...
                                                <a name="" id="" class="btn btn-primary"
                                                    href="#" role="button">Mới</a>
                                                <a name="" id="" class="btn btn-success"
                                                    href="#" role="button">Thêm</a>
                                                <a name="" id="" class="btn btn-warning"
                                                    href="#" role="button">Sửa</a>
                                ...
                                <hr>
                                <div class="timkiem">
                                    <input type="text" class="form-control-sm" aria-label=".form-control-sm example" placeholder="Nhập tên tìm kiếm"> 
                                   <a name="" id="" class="btn btn-secondary btn-sm" href="#" role="button">Tìm kiếm</a>
                                </div>
