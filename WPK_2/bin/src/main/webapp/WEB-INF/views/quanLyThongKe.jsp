                        ...
                        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light"
                            ...
                            <ul class="nav nav-pills flex-column mb-auto">
                                <li class="mb-1">
                                    ...
                                    <div class="collapse" id="sanpham-collapse">
                                        <ul
                                ...
                                <li class="mb-1">
                                    ...
                                    <div class="collapse show" id="thongke-collapse">
                                        <ul
                                            class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="home-tab"
                                        ...
                                        aria-selected="true">Top sản phẩm bán</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                ...
                                <div class="tab-pane fade show active"
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <a name id class="btn btn-info btn-sm"
                                            href="#" role="button">Tăng dần</a>
                                        <a name id class="btn btn-danger btn-sm"
                                            href="#" role="button">Giảm dần</a>
                                    </div>
                                ...
                                <div class="tab-pane fade" id="profile-tab-pane"
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div class="show-action">
                                                <input name id class="btn btn-light"
                                                    type="date" value="Button">
                                                <a name id class="btn btn-light"
                                                    href="#" role="button">Tìm kiếm</a>
