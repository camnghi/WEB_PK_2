		...
		<div class="row">
			...
			<div class="tab-content" id="myTabContent">
				<div class="tab-pane fade show active" id="gioithieu-tab-pane"
					...
					<p>Quạt tản nhiệt gaming cho điện thoại, tản nhiệt sò lạnh siêu
						mát DL01 Gemini Shop</p>
					<p>Đặc điểm nổi bật:</p>
					<p>Quạt tản nhiệt gaming DL01 cho điện thoại, tản nhiệt sò lạnh
						siêu mát</p>
					<p>Hiện nay gamemobile như PUBG, Liên quân mobile, Call of Duty
						,vv.. đã trở lên quen thuộc với hầu hết người yêu game mobile.</p>
					<p>Shop xin giới thiệu với các bạn sản phẩm quạt tản nhiệt
						gaming DL01 giúp các game thủ chiến các game đồ họa khủng mà không
						sợ nóng máy.</p>
